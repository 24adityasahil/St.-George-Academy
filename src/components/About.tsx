    ...
    <section id="about" className="section-padding bg-white">
      <div className="container mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-school-dark">About St. George Academy</h2>
          <p className="text-gray-600">
            Founded on principles of excellence and innovation, St. George Academy 
