      ...
      <div className="container mx-auto px-4 py-16 md:py-24 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl mb-8 md:mb-12 text-white/90 max-w-2xl mx-auto">
            ...
            development, and innovative learning experiences.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Button
              size="lg"
              className="bg-school-secondary hover:bg-school-secondary/90 text-school-dark font-semibold"
            >
              Explore Programs
            </Button>
            <Button
              size="lg"
              variant="outline"
              className="bg-blue-500 border-white text-white hover:bg-blue-600"
            >
              Schedule a Visit
            </Button>
          </div>
